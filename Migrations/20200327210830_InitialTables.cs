        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardDate = table.Column<int>(nullable: false),
                    UserId = table.Column<string>(nullable: false),
                    OwnerId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreditCards", x => new { x.CardNumber, x.CardDate });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResCancelTime = table.Column<DateTime>(nullable: false),
                    RefundPortion = table.Column<float>(nullable: false),
                    Date = table.Column<DateTime>(nullable: false),
                    FlightNo = table.Column<string>(nullable: false),
                    FlightNo1 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
